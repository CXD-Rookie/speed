      ...
      >
        {errorStateMap.includes(realType) && (
          <div className="real-error-modal-content">
            ...
            {realType === 10 && (
              <p>
                您已成功换绑{process.env.REACT_APP_TID_NAME}
                账户，请在点击确认后重新登录。
              </p>
            )}
        ...
        {sucessStateMap.includes(realType) && (
          <div className="real-sueccess-modal-content">
            ...
            <p>
              ...
              {realType === 6 &&
                `您的${process.env.REACT_APP_TID_NAME}账号已解除绑定`}
              {realType === 7 &&
                `您的${process.env.REACT_APP_TID_NAME}账号已成功绑定至账户`}
              {realType === 8 &&
                `您已成功换绑${process.env.REACT_APP_TID_NAME}账户`}
            </p>
            <Button className="real-sueccess-btn" onClick={handleClose}>
              好的
            </Button>
