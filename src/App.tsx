  ...
  useEffect(() => {
    const handleWebSocketMessage = (event: MessageEvent) => {
      ...
      if (data.code === 0 || data.code === "0") {
        ...
        if (
          userInfo?.user_ext?.name === "" &&
          userInfo?.user_ext?.idcard === ""
        ) {
